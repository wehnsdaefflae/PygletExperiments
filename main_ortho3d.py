...
class OrthoCanvas(Canvas):
    ...
    @staticmethod
    def cube(x: float, y: float, z: float, size: float, orientation: tuple[float, float, float] = (0., 0., 0.), color: tuple[int, int, int, int] = (255, 255, 255, 100)):
    ...
    def _on_draw(self) -> None:
        self.clear()
        self.cube(self.x, self.y, self.z, self.size, (255., 255., 255.))
